...
var WeaponRegistry = map[uint8]WeaponStats{
	WeaponPistol:       {Damage: 25, ClipSize: 12, FireMode: FireModeSemi, TicksPerShot: 10},
	WeaponAssaultRifle: {Damage: 15, ClipSize: 30, FireMode: FireModeAuto, TicksPerShot: 6},
	WeaponBurstRifle:   {Damage: 18, ClipSize: 24, FireMode: FireModeBurst, TicksPerShot: 5, BurstCount: 3},
	WeaponSniper:       {Damage: 90, ClipSize: 5, FireMode: FireModeSemi, TicksPerShot: 60},
}